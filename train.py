...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_rw.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/rw.yaml', help='dataset.yaml path')
